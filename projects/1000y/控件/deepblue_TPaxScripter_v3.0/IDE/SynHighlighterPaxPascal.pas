...
type
  TSynPaxPascalSyn = class(TSynCustomHighlighter)
  private
    fAsmStart: Boolean;
    fRange: TRangeState;
    fLine: PChar;
...
procedure TSynPaxPascalSyn.InitIdent;
var
  I: Integer;
...
function TSynPaxPascalSyn.KeyHash(ToHash: PChar): Integer;
begin
...
function TSynPaxPascalSyn.KeyComp(const aKey: string): Boolean;
var
  I: Integer;
  Temp: PChar;
begin
...
function TSynPaxPascalSyn.Func15: TtkTokenKind;
var
  I: Integer;
begin
  Result := tkIdentifier;
  for I:=0 to PaxPascalKeywords.Count - 1 do
    if KeyComp(PaxPascalKeywords[I]) then
    begin
      Result := tkKey;
      Exit;
    end;
