...
const
    ...
    C_p_ID          = 8014;        //任务ID
    C_p_ItemPre     = '令牌8014';  //前驱任务品
    C_p_Item        = '头颅8014';  //任务物品
    C_p_ItemPreView = '缉拿令牌';  //前驱任务品
    C_p_ItemView    = '豺狼头颅';  //任务物品
    C_p_ItemSum     = 15;          //任务物品个数
    C_p_Reward      = 30;          //任务奖励
    C_p_Multiple    = 2;           //奖励倍数
    C_p_MenuName    = '剿灭豺狼1'; //任务名字
    C_p_Des         = '帮我去杀一些豺狼回来。'; //接任务描述
    ...
    C_x_ID          = 8214;        //任务ID
    C_x_ItemPre     = '令牌8214';  //前驱任务品
    C_x_Item        = '头颅8214';  //任务物品
    C_x_ItemPreView = '缉拿令牌';  //前驱任务品
    C_x_ItemView    = '豺狼头颅';  //任务物品
    C_x_ItemSum     = 15;          //任务物品个数
    C_x_Reward      = 7000000;     //任务奖励
    C_x_Multiple    = 2;           //奖励倍数
    C_x_MenuName    = '剿灭豺狼2'; //任务名字
    C_x_Des         = '帮我去杀一些豺狼回来。'; //接任务描述
    ...
    C_m_ID          = 8114;        //任务ID
    C_m_ItemPre     = '令牌8114';  //前驱任务品
    C_m_Item        = '首级8114';  //任务物品
    C_m_ItemPreView = '缉拿令牌';
    C_m_ItemView    = '豺狼首级';
    C_m_ItemSum     = 15;          //任务物品个数
    C_m_Reward      = 30000;       //任务奖励
    C_m_Multiple    = 2;           //奖励倍数
    C_m_MenuName    = '剿灭豺狼3';  //任务名字
    C_m_Des         = '帮我去杀一些豺狼回来。'; //接任务描述
