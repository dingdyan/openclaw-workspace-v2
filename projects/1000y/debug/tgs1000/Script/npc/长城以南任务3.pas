...
const
    ...
    C_p_ID          = 8003;        //任务ID
    C_p_ItemPre     = '令牌8003';  //前驱任务品
    C_p_Item        = '头颅8003';  //任务物品
    C_p_ItemPreView = '缉拿令牌';  //前驱任务品
    C_p_ItemView    = '犀牛头颅';  //任务物品
    C_p_ItemSum     = 15;          //任务物品个数
    C_p_Reward      = 30;          //任务奖励
    C_p_Multiple    = 2;           //奖励倍数
    C_p_MenuName    = '剿灭犀牛1'; //任务名字
    C_p_Des         = '帮我去杀一些犀牛回来。'; //接任务描述
    ...
    C_x_ID          = 8203;        //任务ID
    C_x_ItemPre     = '令牌8203';  //前驱任务品
    C_x_Item        = '头颅8203';  //任务物品
    C_x_ItemPreView = '缉拿令牌';  //前驱任务品
    C_x_ItemView    = '犀牛头颅';  //任务物品
    C_x_ItemSum     = 15;          //任务物品个数
    C_x_Reward      = 7000000;     //任务奖励
    C_x_Multiple    = 2;           //奖励倍数
    C_x_MenuName    = '剿灭犀牛2'; //任务名字
    C_x_Des         = '帮我去杀一些犀牛回来。'; //接任务描述
    ...
    C_m_ID          = 8103;        //任务ID
    C_m_ItemPre     = '令牌8103';  //前驱任务品
    C_m_Item        = '首级8103';  //任务物品
    C_m_ItemPreView = '缉拿令牌';
    C_m_ItemView    = '犀牛首级';
    C_m_ItemSum     = 15;          //任务物品个数
    C_m_Reward      = 30000;       //任务奖励
    C_m_Multiple    = 2;           //奖励倍数
    C_m_MenuName    = '剿灭犀牛3'; //任务名字
    C_m_Des         = '帮我去杀一些犀牛回来。'; //接任务描述
    C_m_Des_end     = '那么快就回来了，消灭他们了吗？'; //交任务描述
