...
begin                                                                           // 傍拜加档
    A2LabelMsg1.Caption := ('攻击速度+上身攻击之合100') + '(' + IntToStr(_StrToInt(A2EditSpeed.text) + _StrToInt(A2EditDamegeBody.Text)) + ')';
    A2LabelMsg2.Caption := '';
end;
...
begin                                                                           //磊技焊沥
    A2LabelMsg1.Caption := ('恢复+躲闪之合是100') + '(' + IntToStr(_StrToInt(A2EditRecovery.text) + _StrToInt(A2EditAvoid.Text)) + ')';
    A2LabelMsg2.Caption := '';
end;
