...
begin
    ...
    begin
        ...
        result := 'insert into uUserItem ( ';
        result := result + ' lusername, ltype, lkey,rid, rname, rcount, rcolor, rDurability, rDurabilityMax, ';
        result := result + ' rlevel, rAdditional, rlockState, rlocktime,  rsettingcount, rsetting1, rsetting2, rsetting3, rsetting4,rDateTime)';
        result := result + ' values ( ';
        result := result + '''' + (ausername) + ''',';
        result := result + '''' + (atype) + ''',';
        result := result + '''' + inttostr(akey) + ''',';
