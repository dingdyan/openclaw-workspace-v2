...
interface
uses Windows, SysUtils, Classes, Usersdb, Deftype, uKeyClass;
...
//            3000
       ...
       { end;
        ...
        begin}
            ...
            begin
                if rcLifeData.armorBody > 0 then rcLifeData.armorBody := rcLifeData.armorBody + 100;
