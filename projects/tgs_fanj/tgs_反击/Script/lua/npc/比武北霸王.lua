...
function OnDie(uSource, uDest, uRace)
  ...
  B_SAY(uDest, '不可思议_你怎么可能...'); 
  M_MapRegen(69);
  P_MapMove(uSource, 69, 20, 18, 500);
