...
function OnDie(uSource, uDest, uRace)
  ...
  B_SAY(uDest, '后会有期_我会记住阁下名字的'); 
  M_MapRegen(60);
  P_MapMove(uSource, 60, 20, 18, 500);
