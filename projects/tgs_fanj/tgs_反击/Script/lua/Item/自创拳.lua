...
function OnItemDblClick(uSource, uItemKey, astr)
   ...
   if ItemData == nil or ItemData.Name ~= '无极玄功拳' then
     return;
   end;
    --检测是否修炼
    ...
    if P_AddMagicAndLevel(uSource, '无极玄功拳', 100) then
       P_deleteitem(uSource ,ItemData.Name ,1,'无极玄功拳');
       P_saysystem(uSource, '学习[无极玄功拳]成功!', 15);
	 return;
      end
       return;
      end