...
function OnItemDblClick(uSource, uItemKey, astr)
   ...
   if ItemData == nil or ItemData.Name ~= '紧罗那王枪' then
     return;
   end;
    --检测是否修炼
    ...
    if P_AddMagicAndLevel(uSource, '紧罗那王枪', 100) then
       P_deleteitem(uSource ,ItemData.Name ,1,'紧罗那王枪');
       P_saysystem(uSource, '学习[紧罗那王枪]成功!', 15);
	 return;
      end
       return;
      end