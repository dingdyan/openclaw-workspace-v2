...
function OnItemDblClick(uSource, uItemKey, astr)
   ...
   if ItemData == nil or ItemData.Name ~= '回风落雁槌' then
     return;
   end;
    --检测是否修炼
    ...
    if P_AddMagicAndLevel(uSource, '回风落雁槌', 100) then
       P_deleteitem(uSource ,ItemData.Name ,1,'回风落雁槌');
       P_saysystem(uSource, '学习[回风落雁槌]成功!', 15);
	 return;
      end
       return;
      end