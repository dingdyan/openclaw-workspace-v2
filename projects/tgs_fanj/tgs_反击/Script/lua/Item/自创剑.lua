...
function OnItemDblClick(uSource, uItemKey, astr)
   ...
   if ItemData == nil or ItemData.Name ~= '韦陀伏魔剑' then
     return;
   end;
    --检测是否修炼
    ...
    if P_AddMagicAndLevel(uSource, '韦陀伏魔剑', 100) then
       P_deleteitem(uSource ,ItemData.Name ,1,'韦陀伏魔剑');
       P_saysystem(uSource, '学习[韦陀伏魔剑]成功!', 15);
	 return;
      end
       return;
      end