...
const
    ...
    C_p_ItemView    = '北方魔人的头颅'; //任务物品
    C_p_ItemSum     = 15;          //任务物品个数
    C_p_Reward      = 30;          //任务奖励
    C_p_Multiple    = 2;           //奖励倍数
    C_p_MenuName    = '剿灭北方魔人'; //任务名字
    C_p_Des         = '一群可恶的北方魔人，目无王法，鱼肉百姓。^'
        + '你能帮我去消灭他们吗？^'; //接任务描述
    ...
    C_x_ItemView    = '北方魔人的头颅'; //任务物品
    C_x_ItemSum     = 15;          //任务物品个数
    C_x_Reward      = 7000000;     //任务奖励
    C_x_Multiple    = 2;           //奖励倍数
    C_x_MenuName    = '剿灭北方魔人2'; //任务名字
    C_x_Des         = '一群可恶的北方魔人，目无王法，鱼肉百姓。^'
        + '你能帮我去消灭他们吗？^'; //接任务描述
    ...
    C_m_Multiple    = 2;           //奖励倍数
    C_m_MenuName    = '惩歼除恶';  //任务名字
    C_m_Des         = '北方魔人已进入中原，妄图称霸武林，你觉得^可能吗^'; //接任务描述
