...
uses
  ...
  A2Img, Dialogs, StdCtrls, A2Form, ExtCtrls, CharCls, Deftype;
...
uses FMain, FAttrib, FLogOn, AtzCls, uAnsTick, cltype, filepgkclass,
  FBottom, BackScrn, Math, uPersonBat, Unit_console, FQuest, FSkill;
...
begin
  ...
  begin
    SetItemLabel(ILabelsQuest[akey], '', aitem.rColor, aitem.rshape, 0, 0);
...
begin
  ...
  begin
    ...
    SetItemLabel(ILabels[akey], '', aitem.rColor, aitem.rshape, idx, 0);
//        FrmBottom.ShortcutKeyUP(akey + 60);
...
begin
  ...
  GETCMD.rKEY3 := akeyid;
  FrmLogon.SocketAddData(SIZEOF(GETCMD), @GETCMD);
end;
...
{        A2Panel1.Left := 0;
        ...
        A2Button_close.Left := 220;
        A2Button_close.Top := 15;

        A2ILabel1.Left := 166;                                                  //166,12
        A2ILabel1.Top := 52 - 40;
        A2ILabel2.Left := 14;                                                   //14,50
        A2ILabel2.Top := 90 - 40;
        A2ILabel3.Left := 204;                                                  //204,50
        A2ILabel3.Top := 90 - 40;
        A2ILabel4.Left := 166;                                                  //166,50
        A2ILabel4.Top := 90 - 40;

        A2ILabel6.Left := 52;                                                   //52,50
        A2ILabel6.Top := 90 - 40;
        A2ILabel7.Left := 14;                                                   //14,12
        A2ILabel7.Top := 52 - 40;
        A2ILabel8.Left := 52;                                                   //52,12
        A2ILabel8.Top := 52 - 40;
        A2ILabel9.Left := 204;                                                  //204,12
        A2ILabel9.Top := 52 - 40;

        A2Button_win.Left := 24;
        A2Button_win.Top := 89;

        A2Button_fdmode.Left := 176;
        A2Button_fdmode.Top := 89;
