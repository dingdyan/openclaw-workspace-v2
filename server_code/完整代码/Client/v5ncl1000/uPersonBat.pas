...
uses
  A2Img, BackScrn, Controls, AUtil32, SysUtils, Deftype, Graphics, uAnsTick, classes;
...
type
  ...
  public
    ...
    procedure add(astr: string; acolor: word);
  ...
  public
    ...
    procedure update(atick: integer);
    procedure AdxPaint(atick: integer);
    procedure LeftMsgListadd(astr: string; acolor: word);
    procedure LeftMsgListadd2(astr: string; acolor: word);
    procedure LeftMsgListadd3(astr: string; acolor: word);
...
implementation
uses CharCls, filepgkclass, FMain, FAttrib, FBottom;
{O+}
...
procedure TRollMsgFrom.add(astr: string; acolor: word);
var
  t: TRollMsg;
begin
  if astr = '' then exit;
...
procedure TRollMsg.add(astr: string; acolor: word);
begin
  if astr = '' then exit;
  FMSGSHOW := true;
  FmsgRoll := true;
...
procedure TPersonBat.LeftMsgListadd(astr: string; acolor: word);
begin
  LeftRollMsgFrom.add(astr, acolor);
end;

procedure TPersonBat.LeftMsgListadd2(astr: string; acolor: word);
begin
  LeftRollMsgFrom2.add(astr, acolor);
end;

procedure TPersonBat.LeftMsgListadd3(astr: string; acolor: word);
begin
  LeftRollMsgFrom3.add(astr, acolor);
end;
