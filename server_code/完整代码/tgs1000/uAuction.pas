...
type
  ...
  public
    ...
    procedure openAucitonWindows(uUser: tuser);
...
procedure TAuctionSystemClass.openAucitonWindows(uUser: tuser);
var
  i: integer;
  adata: TWordComData;
begin
...
begin
  ...
  case amaxtime of
    ...
    begin
      uUser.SendClass.SendChatMessage('出售时间问题。', SAY_COLOR_SYSTEM);
      exit;
    end;
  end;
