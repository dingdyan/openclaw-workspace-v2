...
uses
    ...
    Dialogs, StdCtrls, ExtCtrls, ComCtrls, Grids, deftype, uKeyClass;
...
type
    ...
    TDBMagicSelectState = (DBMSS_BASIC, DBMSS_MAGIC);
    //                       基本           武功
...
begin
    ...
    Edit_LastDate.Text := DateTimeToStr(UserData.LastDate);
    Edit_CreateDate.Text := DateTimeToStr(UserData.CreateDate);
...
begin
    ...
    UserData.LastDate := StrToDateTime(Edit_LastDate.Text);
    UserData.CreateDate := StrToDateTime(Edit_CreateDate.Text);
