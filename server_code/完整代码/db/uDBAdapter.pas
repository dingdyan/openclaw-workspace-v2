...
type
    ...
    public
        ...
        function UserUpdate(aIndexName: string; aDBRecord: PTDBRecord_20091013): Byte;
        function UserSelect(aIndexName: string; aDBRecord: PTDBRecord_20091013): Byte;
        function UserSelectAllName(): string;
        function UserInsert(aIndexName: string; aDBRecord: PTDBRecord_20091013): Byte;
...
var
    aHead: TDbHeadFile;
begin
    aHead.rVer := '酷引擎_1000y_2009_06_01';                                    // '酷引擎_1000y_2009_06_01';
    aHead.rNewCount := 5000;
    aHead.rUseCount := 0;
    aHead.rMaxCount := 0;
...
function TUserDBAdapter_2009_06_01.UserInsert(aIndexName: string; aDBRecord: PTDBRecord_20091013): Byte;
begin
    result := dbfile.Insert(aIndexName, aDBRecord, sizeof(TDBRecord_20091013));
end;

function TUserDBAdapter_2009_06_01.UserSelect(aIndexName: string; aDBRecord: PTDBRecord_20091013): Byte;
begin
    result := dbfile.Select(aIndexName, aDBRecord, sizeof(TDBRecord_20091013));
end;

function TUserDBAdapter_2009_06_01.UserUpdate(aIndexName: string; aDBRecord: PTDBRecord_20091013): Byte;
begin
    result := dbfile.Update(aIndexName, aDBRecord, sizeof(TDBRecord_20091013));
end;
