...
PYTHON_SCRIPT="$SCRIPT_DIR/redpacket_advanced_monitor.py"
...
# 运行Python脚本
cd "$SCRIPT_DIR"
python3 "$PYTHON_SCRIPT" 2>&1 | tee "$LOG_DIR/redpacket_advanced_monitor_$(date +%Y%m%d_%H%M%S).log"
